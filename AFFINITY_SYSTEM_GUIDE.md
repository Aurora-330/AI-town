...
第二次对话:
玩家: "你整理线索的方式真厉害,一下就把重点说清了!"
风泠: "谢谢你。有人愿意认真对待细节,总是会让我更愿意多说一点。"
📈 好感度: 55 -> 63 (赞美能力) → 关系等级提升: 友好 -> 亲密

第三次对话:
玩家: "能教教我吗?"
风泠: "当然可以!我很乐意分享。你想从哪里开始?"
📈 好感度: 63 -> 69 (请教学习)
```
...
批评对话:
玩家: "你说这些也太绕了,根本没必要这么较真!"
风泠: "如果你只是想跳过关键细节,那我确实帮不了你太多。"
📉 好感度: 69 -> 61 (否定边界) → 关系等级降低: 亲密 -> 友好
```
...
好感度: 70 (亲密)
玩家: "你好,最近怎么样?"
郁米: "还不错。我这两天在整理一些心情便签,你要是愿意,也可以和我说说你的近况。" (热情详细)

好感度: 90 (挚友)
玩家: "你好,最近怎么样?"
郁米: "哈哈,老朋友!最近忙得不行,但很充实。对了,上次你问的那个问题,我找到答案了!" (亲切主动)
```
...
```http
PUT /npcs/风泠/affinity?affinity=80&player_id=player
```

**响应:**
```json
{
    "message": "已设置风泠对玩家的好感度",
    "npc_name": "风泠",
    "player_id": "player",
    "affinity": 80.0,
    "level": "挚友",
